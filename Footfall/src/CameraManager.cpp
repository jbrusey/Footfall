...
void CameraManager::draw()
{
	...
	placeScreen(videoMatrix, 0, 0, false, true);
	placeScreen(background, 1, 0, false, true);
	placeScreen(unprocessed_MOG,  0, 1, false, true);
	placeScreen(processedMog, 1, 1, false, true);
