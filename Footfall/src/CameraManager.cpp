...
void CameraManager::draw()
{
	...
	drawMat(unprocessed_MOG, videoMatrix.cols, videoMatrix.rows,videoMatrix.cols,videoMatrix.rows);
	//ofDrawBitmapStringHighlight("Shadows Image", ((videoMatrix.cols/2)*3)-45,(videoMatrix.rows*2)+50);
	drawMat(processedMog, 0, videoMatrix.rows,videoMatrix.cols,videoMatrix.rows);
