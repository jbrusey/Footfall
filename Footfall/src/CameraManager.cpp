...
void CameraManager::draw()
{
	...
	placeScreen(0, 0, false, true);
	placeScreen(1, 0, false, true);
	placeScreen(0, 1, false, true);
	placeScreen(1, 1, false, true);
...
void placeScreen(int x, int y, bool full, bool border)
{
	Mat screen;
	string caption = "Test";
	if (full)
